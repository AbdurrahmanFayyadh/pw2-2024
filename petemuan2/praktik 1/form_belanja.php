    ...
    <form method="GET" action="form_belanja.php" class="w-75 mt-5 mx-auto p-4 border shadow-sm">
        ...
        <div class="container px-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input name="jumlah" style= id="jumlah" placeholder="Jumlah beli" type="number" min=0 class="form-control" required>
                </div>
            </div>
            <div class="form-group row">
                <div class="offset-4 col-8">
                    <input name="submit" type="submit" name="submit" value="Submit" class="btn btn-dark">
                </div>
            </div>
