...
<body>
    ...
    <form class="form-horizontal w-75 mt-5 mx-auto p-4 border shadow-sm" method="POST" action="hasil_nilai_siswa.php">
        ...
        <div class="container px-3">
            ...
            <div class="form-group row mb-3">
                <div class="offset-4 col-8">
                    <input type="submit" name="proses" value="Submit" class="btn btn-dark">
                </div>
            </div>
        </div>
    </form>
